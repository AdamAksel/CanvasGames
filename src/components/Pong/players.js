function movePlayer(entity1, entity2, arr1, arr2) {
...
export function handlePlayers(ctx, entity1, entity2, arr1, arr2) {
  movePlayer(entity1, entity2, arr1, arr2)
  draw(ctx, entity1, entity2)
}
